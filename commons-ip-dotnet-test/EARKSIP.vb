...
<TestClass()> Public Class EARKSIPTest

    <TestMethod()> Public Sub buildSIP()
        Try
            ...
            Assert.AreEqual(zipSIP.getFileName().toString, "SIP_1.zip")

        Catch ex As Exception
            Assert.Fail("Failt to creat zip file " & ex.Message)
        End Try
